...
namespace Quarantine
{
	public static class Outfits
	{
		...
		public static void DrawSprites(DirectBitmap bitmap, int[] bitmapIndex)
		{
			int destx = 0;
			...
			void DrawSprite(int body)
			{
				...
				{
					sprites[outfit - 1][body].Render(destx, bitmap.Width, bitmap.Bits, palette, bitmapIndex, index);
				}
			}
		}
